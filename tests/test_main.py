...
from src.main import (PATH_TO_FILE, choice_status, financial_transactions, greeting,
                      main, only_rub, output_result, sorting_by_date)


@patch("builtins.input", side_effect="1")
def test_greeting(mock: MagicMock) -> None:
    assert greeting() == financial_transactions(PATH_TO_FILE)
